...
<div align="center">
  ...
  <h1 align="center">PERLIN MOUNTAINS</h1>
  <h3 align="center"> Pʀᴏᴄᴇᴅᴜʀᴀʟ ASCII Mᴏᴜɴᴛᴀɪɴs Rᴇɴᴅᴇʀᴇʀ </h3>
</div>
...
<img src="assets/perlinmountains.clip.gif" alt="Perlin Mountains Walkthrough" width="100%">

<p align="center"><i>An interactive p5.js ASCII art generator that procedurally renders continuous ridged mountain terrain using stacked octaves of Perlin noise and high-performance flat array cache loops.</i></p>

The Perlin Mountains component acts as an immersive, ambient background and interactive visualization tool. It procedurally crafts ridged mountain ranges on a grid of characters, dynamically adapting character sizes, frame rates, and noise octaves. It features full-pane reparenting and a slide-out parameter editor.
...
| File | Description |
| :--- | :--- |
| **[PERLIN MOUNTAINS.md](PERLIN%20MOUNTAINS.md)** | The main entry point designed to be loaded inside Obsidian canvases or workspace leaves. |
...
| **[src/components/PerlinComponent.jsx](src/components/PerlinComponent.jsx)** | The core interactive p5.js sketch module and GUI integration block. |
| **[src/styles/styles.jsx](src/styles/styles.jsx)** | CSS-in-JS style definition map for canvas view wrappers and controllers. |
| **[src/utils/domUtils.jsx](src/utils/domUtils.jsx)** | DOM traversal utilities to locate target workspace workspace leafs. |
