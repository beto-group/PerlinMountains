...
const { App } = await dc.require(dc.resolvePath("PERLIN MOUNTAINS/src/App.jsx"));
...
const RootView = (props) => {
  ...
  useEffect(() => {
    ...
    styleEl.id = "perlin-mountains-immersive";
    ...
    const interval = setInterval(async () => {
      try {
        const cmdFile = dc.resolvePath("PERLIN MOUNTAINS/data/mcp_commands.json");
    ...
    return () => {
      ...
      const existing = document.getElementById("perlin-mountains-immersive");
